...
export const checkLogIn = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    ...
    console.log('dât khi login tra ve', data);
...
export const unitSlice = createSlice({
  ...
  extraReducers(builder: any) {
    ...
    builder.addCase(checkLogIn.fulfilled, (currentState: any, action: any) => {
      ...
      currentState.email = action.payload.account.email;
      currentState.refreshToken = action.payload.account.refreshToken;
      currentState.qrCode = action.payload.account.qrCode
      currentState.isConfirmed = action.payload.account.isConfirmed
      console.log('email khi dang nhap thanh cong', action.payload.account)
      console.log('email khi dang nhap thanh cong accessToken',  action.payload.accessToken,)
      console.log('email khi dang nhap thanh cong RefreshToken', action.payload.refreshToken,)
