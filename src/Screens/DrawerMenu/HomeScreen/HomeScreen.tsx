...
import { fetchAccountAsync } from '@/redux/Reducers/CategoryReducers';
...
const HomeScreen = () => {
  ...
  const getAccountState = useAppSelector(state => state.categoryReducer);
  console.log('getAccountState',getAccountState)
  console.log('getAccountState.category',getAccountState.category)
  console.log('getAccountState.category',getAccountState.category)
  console.log('getAccountState.category',getAccountState.category)
  ...
  const refreshATToken = async () => {
    ...
    dispatch(fetchAccountAsync(payload));
  }
